...
def generate_localized_advisory(
    ...
    en = (
        ...
        f"AQI {aqi} ({category}) at {event_time}. "
    ...
    hi = (
        f"गंभीर वायु गुणवत्ता चेतावनी — {station_name} स्टेशन पर "
        f"{event_time} पर AQI {aqi} ({category}) दर्ज किया गया है। "
    ...
    mr = (
        f"गंभीर हवा गुणवत्ता इशारा — {station_name} स्थानकावर "
        f"{event_time} ला AQI {aqi} ({category}) नोंदवला गेला आहे। "
        f"प्रमुख प्रदूषक: {dominant_pollutant.upper()}. "
...
def build_actionable_intelligence(
    ...
    advisory = generate_localized_advisory(
        station_name, aqi, dominant_pollutant, top, priority, event_time=event_time
    )
