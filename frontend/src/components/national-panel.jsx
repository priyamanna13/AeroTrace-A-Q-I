  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 lg:gap-[1.2vh]">
        ...
        <h1
          id="national-heading"
          className="text-balance font-display text-4xl font-bold leading-[1.05] tracking-tight md:text-5xl lg:text-[clamp(1.75rem,min(5.4vh,3.6vw),3.75rem)]"
        >
          {t.heading}
        </h1>
        <p className="max-w-md border-l-2 border-copper pl-4 text-pretty text-base leading-relaxed text-muted-foreground md:text-lg lg:text-[clamp(0.8125rem,2vh,1.0625rem)] lg:leading-snug">
          {t.description}
        </p>
      </div>
      ...
      >
        ...
        <div className="flex flex-wrap items-baseline gap-x-5 gap-y-2">
          <span className="font-display text-6xl font-bold leading-none tabular-nums md:text-7xl lg:text-[clamp(2.5rem,7.5vh,4.5rem)]">
            {NATIONAL_AQI}
          </span>
            ...
            return (
              <li key={city.id} className="border-b border-border lg:flex lg:min-h-0 lg:flex-1 lg:basis-0">
                ...
                >
                  ...
                  <span className="w-10 text-right font-mono text-sm tabular-nums">{city.aqi}</span>
