    ...
    <div className="w-full min-h-[calc(100vh-64px)] bg-[#08080a] text-zinc-100 px-4 sm:px-8 py-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-2 text-xs text-zinc-400 font-mono">
          ...
          <span>/</span>
          <Link to="/investigate/Shivajinagar" className="hover:text-zinc-200">{t('nav.investigation')}</Link>
          <span>/</span>
          <span className="text-emerald-400">{t('nav.prediction')}</span>
        </div>
        ...
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 text-xs text-zinc-400 flex items-start gap-3">
          ...
          <div>
            <span className="font-semibold text-zinc-200">Phase 5 Deliverable:</span> {t('screen5.phaseNotice')}
          </div>
        </div>
